...
export interface CampaignTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "MAX_SUPPLY"
      | "allowance"
...
export interface CampaignToken extends BaseContract {
  connect(runner?: ContractRunner | null): CampaignToken;
  waitForDeployment(): Promise<this>;

  interface: CampaignTokenInterface;
